...
if len(sys.argv) >= 4:  #verify all mandatory arguments are in the line           
    ...
    print '\nExample 1:'
    print 'python moveNames.py fasta.fa _ "2_1" > newFile.fa'
    print '\tOld name:'
    print '\t>ATG10442_SP1'
    print '\tNew name:'
    print '\t>SP1_ATG10442'
    ...
    print '\nExample 1b:'
    print 'python moveNames.py fasta.fa _ "1_2" > newFile.fa'
    print '\tOld name:'
    print '\t>ATG10442_SP1'
    print '\tNew name:'
    print '\t>ATG10442_SP1'
    ...
    print '\nExample 2:'
    print 'python moveNames.py fasta.fa _ "2_3_1_something" > newFile.fa'
    print '\tOld name:'
    ...
    print '\nExample 2:'
    print 'python moveNames.py fasta.fastq _ "2_1" "@" > newFile.fq'
    print '\tOld name:'
    print '\t@SEQ1_IDx'
    print '\tNew name:'
    print '\t@IDx_SEQ1'
